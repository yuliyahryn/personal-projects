...
#)
            ...
            prompt = PromptTemplate(
                template="Please extract the technical skills from the following job description and store it in tech_skills.\n{job_description}\n"
                input_variables=[job_description],
            ...
            try:
                output = retry_parser.parse_with_prompt(output, _input)                
